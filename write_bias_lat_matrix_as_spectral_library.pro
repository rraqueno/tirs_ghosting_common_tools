pro write_bias_lat_matrix_as_spectral_library, input_image_filename, detector_positions_filename
...
;matrix[0,*]=weights
  ...
  for i = 4, n_bands  - 1 do begin
   ...
   header = [header, 'TYPE:LAT; '+band_names[i] ]
...
;envi_write_envi_file, weights, file_type=envi_file_type(file_type), out_name='L8-weight_data.sli', interleave=0, ns=n_samples, nl=1, nb=1, spec_names = [case_name], bname=[case_name]


envi_write_envi_file, transposed_matrix, file_type=envi_file_type(file_type), out_name='GOES-LAT_data.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = header, bname=['TYPE:LAT; '+case_name]
...
envi_write_envi_file, transposed_l8_matrix, file_type=envi_file_type(file_type), out_name='L8-LAT_data.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = l8_header, bname=['TYPE:LAT; '+case_name]
