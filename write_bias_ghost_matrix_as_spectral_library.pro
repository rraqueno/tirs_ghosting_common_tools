...
envi_write_envi_file, weights, file_type=envi_file_type(file_type), out_name='ghost_weights.sli', interleave=0, ns=n_samples, nl=1, nb=1, spec_names = [case_name], bname=[case_name]


envi_write_envi_file, transposed_matrix, file_type=envi_file_type(file_type), out_name='GOES_ghost_matrix.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = header, bname=[case_name]
...
envi_write_envi_file, transposed_l8_matrix, file_type=envi_file_type(file_type), out_name='L8_ghost_matrix.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = l8_header, bname=[case_name]
